...
namespace MVCFrame
{
    public partial class FrmDetailed : Form
    {
        ...
        public ListBox LblUnsortedCPUQueue
        {
            get
            {
                return lblUnsortedCPUQueue;
            }
        }
        ...
        private void bClear_Click(object sender, EventArgs e)
        {
            ...
            viewDetailed.model.statistics.Clear();
            endOfSession();
            UpdateSettings();
        }
        ...
        private void bStatistics_Click(object sender, EventArgs e)
        {
            ...
            {
                frmStatistics = new FrmStatistics(viewDetailed.model);
                frmStatistics.Show();
            }
            else
            {
